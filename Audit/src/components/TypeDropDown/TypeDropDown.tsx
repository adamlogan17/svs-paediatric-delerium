 ...
 * @prop { string } props.text The text to be displayed on the dropdown button
 * @prop { string[] } props.options The selectable options of the dropdown
 * @prop { any } [props.onButtonClick] The function which is called when the button is clicked
 * @prop { sting } [props.primaryColour] The background hex code of the button (default is "#025858")
