...
CREATE ROLE admin;
ALTER ROLE admin WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:+JQ+yEcVXV6nNAwF8bVZKw==$D7f0PdrbA7Man938Z8tlFAv0OlUfbRq48rssF3bX7Uo=:48ZxFMGXQX7N1dXlp6w1yQPlTz5prwf4qHCE53u5QS8=';
CREATE ROLE elearning_admin_role;
ALTER ROLE elearning_admin_role WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:AzPgPIgf54SI5ttjX98ykg==$CM6h9lIMKuhW3mrGLxtOtF1BjyaOzUsvcDhxvtw8CdM=:7C4QTDbQH6Nhltx9oT0N30tA+YtM05rXGYCNRUgCq/I=';
CREATE ROLE elearning_field_engineer_role;
ALTER ROLE elearning_field_engineer_role WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Qf+Mje4NYQJxjOpVUKxDDA==$4aFfFOL6knxfVAvinghg7w/6JZ25QHbkhg4gaUL7frE=:jwCeFI4UAfQZJHWGugYXHSyV4ixLZzUs+OQOOkmc4I8=';
CREATE ROLE field_engineer;
ALTER ROLE field_engineer WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:5ixcBQA3TL21d3KuaXOdKg==$bHPmQCbVKwhbhD0pXLpAOiMwKAhhtKKsSwl9qM2Inyc=:CfuHdjT0BgK8cSHFvFWM7vfDFpM87mUeRTSs/Q3q+Aw=';
CREATE ROLE learner_role;
ALTER ROLE learner_role WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:3NicFcvpPlQNFBPU4puvmg==$ic40R0mycJwwVqg9e+1z52JYIZQe+XzD1sVM/esknOw=:2vGJfzFc4fxHZ84n3DVIL9LRrFWLrxFpVJwLd0C31V4=';
CREATE ROLE picu;
ALTER ROLE picu WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:6ZEkbHg/uW40vOrotLTjXA==$6JBlsJ+Rksu73I1sWgAaA7b8O6AZ1NggKRZb/5UBwTQ=:UwV6fQQ1uAegJuKORi7aRAwCZM7H+tBn+WPtvotblu0=';
CREATE ROLE postgres;
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:7Nk30ZGGmNxPG6j0Wuc3zQ==$Qb0xCK7/zEKNFDVYwqSSF2agUoRmNj2m1WCs1xAaLh0=:QWhe8ZvnLYr/ThiW5QQBLbQK5ZZwbrkktFvdqYkPqSg=';
CREATE ROLE test_user;
ALTER ROLE test_user WITH SUPERUSER INHERIT NOCREATEROLE CREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:x+zDy7yX3xczkkcMwTwOEQ==$6nGTAu+JgBGCHfDXy8anGvp/J20ib3ralOqr+2czyMM=:Q3n3u8TqzYdnJG8LrVRAEwdcp6dsWYIiAzhqrB3zCOY=';
...
2023-11-19	18:34:58	OPTIONS	/verify-captcha	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
2023-11-19	18:34:59	POST	/verify-captcha	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
2023-11-19	18:34:59	OPTIONS	/login	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
2023-11-19	18:34:59	POST	/login	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
2023-11-19	18:35:05	POST	/backupPostgres	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
2023-11-19	18:35:17	POST	/restoreDump	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
2023-11-19	18:35:40	POST	/restorePostgres	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
2023-11-19	18:38:32	POST	/restoreChildDump	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
2023-11-19	18:44:29	POST	/restoreChildDump	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
2023-11-19	18:45:19	POST	/restoreChildDump	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
2023-11-19	18:48:03	POST	/backupPostgres	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
2023-11-19	18:48:08	POST	/restorePostgres	200	::ffff:172.19.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0	\N	\N
\.
...
CREATE TABLE public.compliance_data_backup (
    ...
    score numeric,
    picu_id integer NOT NULL,
    CONSTRAINT compliance_data_backup_method_check CHECK (((method)::text = ANY ((ARRAY['SOSPD'::character varying, 'CAPD'::character varying])::text[])))
);
...
CREATE TABLE public.picu_backup (
    ...
    picu_role character varying DEFAULT 'picu'::character varying NOT NULL,
    overall_compliance numeric,
    CONSTRAINT picu_backup_picu_role_check CHECK (((picu_role)::text = ANY ((ARRAY['picu'::character varying, 'admin'::character varying, 'field_engineer'::character varying])::text[])))
);
